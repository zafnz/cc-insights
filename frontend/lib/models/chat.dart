...
class ChatState extends ChangeNotifier {
  ...
  ChatState(this._data, {String? agentId}) : _agentId = agentId {
  ...
  bool get isInputEnabled =>
      _selectedConversationId == null && !_agentRemoved;
  ...
  Future<void> startSession({
    ...
    _t('ChatState', 'Using agent-keyed transport for agent $_agentId');
