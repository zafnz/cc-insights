...
class MacroExecutor {
  ...
  static Future<void> createChatAndSendMessage(
    ...
    chat.settings.setModel(model ?? worktree.welcomeModel);
    chat.settings.setSecurityConfig(securityConfig ?? worktree.welcomeSecurityConfig);
    chat.settings.setReasoningEffort(reasoningEffort ?? worktree.welcomeReasoningEffort);
