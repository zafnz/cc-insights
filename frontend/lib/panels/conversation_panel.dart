...
class _ConversationPanelState extends State<ConversationPanel>
  ...
  Future<void> _handleSubmit(
    ...
    if (!chat.hasActiveSession) {
      ...
      // TODO: Implement auto-generated chat titles for ACP
      // if (chat.isAutoGeneratedName) {
      //   // Need to port generateChatTitle from SdkMessageHandler to work with ACP
      // }
...
class _WelcomeCardState extends State<WelcomeCard> {
  ...
  Future<void> _createChatAndSendMessage(
    ...
    // This is a placeholder that will be replaced with an AI-generated title
    final chatName = _generateChatName(text);

    // Create a new chat in the worktree with auto-generated name flag
    ...
    // TODO: Implement auto-generated chat titles for ACP
    // The legacy SdkMessageHandler had generateChatTitle() which used AskAiService
    // to generate titles. This needs to be re-implemented for ACP.
