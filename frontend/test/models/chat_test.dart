...
void main() {
  ...
  group('ChatState', () {
    ...
    // Note: 'concurrent permission requests' test group was removed
    // as it tested legacy SDK permission methods that have been removed
    // in favor of ACP permission handling.
  });
}
