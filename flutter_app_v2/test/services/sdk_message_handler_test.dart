  ...
  group('SdkMessageHandler', () {
    ...
    group('Task tool spawning', () {
      ...
      test('uses default values when Task input is incomplete', () {
            ...
            'content': [
              {
                ...
                'name': 'Task',
                'input': {}, // Missing subagent_type/name and prompt
              },
            ],
          },
        });
        ...
        // Default label when subagent_type/name is missing
        check(conv.label).equals('Agent');
        // Task description is null when prompt is missing
